...
K3s peut exécuter tous les charges de travail Kubernetes, mais il a un empreinte plus petite et nécessite moins de ressources qu'une installation Kubernetes traditionnelle.
